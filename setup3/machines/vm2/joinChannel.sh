...
fetchChannelBlock() {
    ...
    peer channel fetch 0 ./channel-artifacts/$CHANNEL_NAME.block -o localhost:10750 \
...
updateAnchorPeers() {
    setGlobalsForPeer0Org2
    # Replace localhost with your orderer's vm IP address
    peer channel update -o localhost:10750 --ordererTLSHostnameOverride orderer.amazonbiobank.mooo.com \
