createcertificatesForOrg1() {
  ...
  echo
  fabric-ca-client enroll -u https://peer1:peer1pw@localhost:7054 --caname ca.org1.example.com -M ${PWD}/../crypto-config/peerOrganizations/org1.example.com/peers/peer1.org1.example.com/tls --enrollment.profile tls --csr.hosts peer1.org1.example.com --csr.hosts localhost --csr.hosts peer1.org1.amazonbiobank.duckdns.org --tls.certfiles ${PWD}/fabric-ca/org1/tls-cert.pem
