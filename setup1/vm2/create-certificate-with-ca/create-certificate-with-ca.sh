createCertificateForOrg2() {
  ...
  fabric-ca-client enroll -u https://peer1:peer1pw@localhost:8054 --caname ca.org2.example.com -M ${PWD}/../crypto-config/peerOrganizations/org2.example.com/peers/peer1.org2.example.com/tls --enrollment.profile tls --csr.hosts peer1.org2.example.com --csr.hosts localhost --csr.hosts peer1.org2.amazonbiobank.duckdns.org --tls.certfiles ${PWD}/fabric-ca/org2/tls-cert.pem
