createCretificateForOrderer() {
  ...
  fabric-ca-client enroll -u https://orderer:ordererpw@localhost:9054 --caname ca-orderer -M ${PWD}/../crypto-config/ordererOrganizations/example.com/orderers/orderer.example.com/msp --csr.hosts orderer.example.com --csr.hosts localhost --csr.hosts orderer.amazonbiobank.duckdns.org --tls.certfiles ${PWD}/fabric-ca/ordererOrg/tls-cert.pem
  ...
  fabric-ca-client enroll -u https://orderer2:ordererpw@localhost:9054 --caname ca-orderer -M ${PWD}/../crypto-config/ordererOrganizations/example.com/orderers/orderer2.example.com/msp --csr.hosts orderer2.example.com --csr.hosts localhost --csr.hosts orderer2.amazonbiobank.duckdns.org --tls.certfiles ${PWD}/fabric-ca/ordererOrg/tls-cert.pem
  ...
  fabric-ca-client enroll -u https://orderer2:ordererpw@localhost:9054 --caname ca-orderer -M ${PWD}/../crypto-config/ordererOrganizations/example.com/orderers/orderer2.example.com/tls --enrollment.profile tls --csr.hosts orderer2.example.com --csr.hosts localhost --csr.hosts orderer2.amazonbiobank.duckdns.org --tls.certfiles ${PWD}/fabric-ca/ordererOrg/tls-cert.pem
  ...
  fabric-ca-client enroll -u https://orderer3:ordererpw@localhost:9054 --caname ca-orderer -M ${PWD}/../crypto-config/ordererOrganizations/example.com/orderers/orderer3.example.com/msp --csr.hosts orderer3.example.com --csr.hosts localhost --csr.hosts orderer3.amazonbiobank.duckdns.org --tls.certfiles ${PWD}/fabric-ca/ordererOrg/tls-cert.pem
  ...
  fabric-ca-client enroll -u https://orderer3:ordererpw@localhost:9054 --caname ca-orderer -M ${PWD}/../crypto-config/ordererOrganizations/example.com/orderers/orderer3.example.com/tls --enrollment.profile tls --csr.hosts orderer3.example.com --csr.hosts localhost --csr.hosts orderer3.amazonbiobank.duckdns.org  --tls.certfiles ${PWD}/fabric-ca/ordererOrg/tls-cert.pem
