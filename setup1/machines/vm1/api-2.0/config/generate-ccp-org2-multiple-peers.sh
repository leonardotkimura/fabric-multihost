...
# PEERPEM1=../../crypto-config/peerOrganizations/org2.amazonbiobank.mooo.com/peers/peer1.org2.amazonbiobank.mooo.com/tls/tlscacerts/tls-localhost-8054-ca-org2-amazonbiobank-mooo-com.pem
CAPEM=../../../vm2/crypto-config/peerOrganizations/org2.amazonbiobank.mooo.com/msp/tlscacerts/ca.crt

echo "$(json_ccp $ORG $P0PORT $CAPORT $PEERPEM $CAPEM $PEERPEM1 $P0PORT1)" > connection-org2-multiple-peers.json
